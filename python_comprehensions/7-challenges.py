...
characters = ['Homer', 'Apu', 'Bob', 'Marge', 'Milhouse', 'Edna', 'Krusty', 'Bart', 'Moe', 'Lisa', 'Ned', 'Lenny', 'Ralph', 'Maggie', 'Nelson', 'Barney']
...
ages = {'Ally': 33, 'Benny': 28, 'Caddy': 23, 'Danny': 22, 'Ely': 18, 'Franky': 17, 'Georgey': 13}
